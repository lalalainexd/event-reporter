...
describe EventReporterController do
  ...
  context "calling perform print, load, etc" do
    ...
    context "finding records" do
      ...
      it "should print all the records in the cache sorted" do
        Cache.any_instance.should_receive(:print_records).with(@attribute)
        @controller.perform :print, :attribute => @attribute
      end
    end
